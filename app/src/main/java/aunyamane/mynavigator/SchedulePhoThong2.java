...
public class SchedulePhoThong2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ScheduleAdapter2 adapter = new ScheduleAdapter2(getApplicationContext(),round,time);
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l){
                if( i == 0){
                    Intent intent = new Intent(SchedulePhoThong2.this,MainActivity.class);
