...
public class SchedulePhoThong1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ScheduleAdapter adapter = new ScheduleAdapter(getApplicationContext(),round,time);
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l){
                if( i == 0){
                    Intent intent = new Intent(SchedulePhoThong1.this,MainActivity.class);
